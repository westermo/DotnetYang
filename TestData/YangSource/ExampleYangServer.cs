using Ietf.Alarms;
using YangNode = Ietf.Routing.YangNode;
...
public class ExampleYangServer : YangSource.IYangServer
{
    ...
    public Task OnAlarmNotification(Ietf.Alarms.YangNode.AlarmNotification notification, DateTime eventTime)
    {
        throw new NotImplementedException();
    }

    public Task OnAlarmInventoryChanged(Ietf.Alarms.YangNode.AlarmInventoryChanged notification, DateTime eventTime)
    {
        throw new NotImplementedException();
    }
